...
export default function LoginScreen() {
  ...
  const handlePasswordLogin = async () => {
    ...
    try {
      ...
      // Root layout handles profile-completion gating from here.
    } catch (e) {
    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.content}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.title}>WashingBells Store</Text>
        <Text style={styles.subtitle}>Store Owner Portal</Text>
        ...
        <View style={styles.phoneRow}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Store owner's mobile"
...
const styles = StyleSheet.create({
  ...
  logoImg: { width: 104, height: 104, alignSelf: "center", marginBottom: SPACING.lg },
  title: { fontSize: 26, fontWeight: "800", color: COLORS.black, textAlign: "center", marginBottom: 4 },
  subtitle: { fontSize: 14, color: COLORS.textMuted, textAlign: "center", marginBottom: SPACING.xxxl },
  ...
  countryCode: { backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, paddingHorizontal: SPACING.md, justifyContent: "center", marginRight: SPACING.sm },
  countryText: { fontSize: 15, color: COLORS.text },
  input: { flex: 1, backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, padding: SPACING.lg, fontSize: 18, color: COLORS.black },
  passwordRow: {
    flexDirection: "row", alignItems: "center", backgroundColor: COLORS.white,
    borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md,
    paddingRight: SPACING.md, marginBottom: SPACING.xl,
  },
  passwordField: { flex: 1, padding: SPACING.lg, fontSize: 18, color: COLORS.black },
  eyeBtn: { padding: SPACING.xs },
  btn: { backgroundColor: COLORS.storeOrange, paddingVertical: SPACING.lg, borderRadius: RADIUS.full, alignItems: "center", ...SHADOW, shadowColor: COLORS.storeOrange, shadowOpacity: 0.25 },
  btnDisabled: { opacity: 0.5 },
  btnText: { color: COLORS.white, fontSize: 16, fontWeight: "700" },
  otpBtn: { alignItems: "center", paddingVertical: SPACING.md, marginTop: SPACING.md },
  otpBtnText: { color: COLORS.storeOrange, fontSize: 15, fontWeight: "600" },
  hint: { textAlign: "center", color: COLORS.textMuted, fontSize: 12, marginTop: SPACING.xl },
});
